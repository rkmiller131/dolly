...
export const prompts = [
  ...
  "Teenagers jumping from one multiverse to another represented as little worlds of specific interests and hobbies. Little Princess style, fantastic wonder",
